            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card border border-border rounded-2xl p-6 shadow-card">
                ...
                <div className="space-y-3">
                  <h4 className="font-serif text-lg text-[#111111] font-medium">¿No es lo que buscas?</h4>
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 border border-black text-black hover:bg-black hover:text-white rounded-xl font-sans font-medium text-xs transition-all duration-300"
                  >
