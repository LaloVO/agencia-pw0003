      ...
      <main className="min-h-screen bg-background pt-28 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-12 space-y-3">
            <span className="text-[10px] md:text-xs tracking-[0.2em] font-sans font-semibold text-neutral-500 uppercase">
            ...
            <p className="font-sans text-sm md:text-base text-neutral-600 max-w-2xl mx-auto leading-relaxed">
