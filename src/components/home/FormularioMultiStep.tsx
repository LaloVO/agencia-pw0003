    ...
    <div className="w-full max-w-4xl mx-auto px-4 md:px-0">
            ...
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center shrink-0">
                <button
                  ...
                  className={`w-9 h-9 rounded-full border-2 flex items-center justify-center font-sans font-medium text-xs transition-all duration-300
                    ...
                    ${isCurrent && !isCompleted ? "border-[#111111] bg-white text-[#111111] scale-105 shadow-md" : ""}
                ...
                <span className={`text-[10px] md:text-xs mt-1.5 font-sans font-medium hidden md:block
                  ${isCurrent ? "text-[#111111] font-semibold" : "text-[#6E6259]/60"}
                `}>
                  {step.title}
                </span>
              </div>
              {!isLast && (
                <div className="h-[2px] flex-1 bg-[#6E6259]/20 rounded min-w-[20px]">
                  <div
                    className="h-full bg-[#111111] transition-all duration-300 rounded"
      ...
      <div className="bg-white/45 backdrop-blur-lg border border-white/40 rounded-3xl p-6 md:p-10 shadow-elegant mt-8 min-h-[460px] relative transition-all duration-300">
        ...
        {currentStep === 1 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Información Personal</h2>
            ...
            <div className="space-y-5 max-w-lg mx-auto">
              <div className="space-y-2">
                <Label htmlFor="nombreCompleto" className="font-sans text-sm font-medium text-[#111111] flex items-center gap-2">
                ...
                <Input
                  ...
                  className={`rounded-full bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#111111] focus:ring-0 ${
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="font-sans text-sm font-medium text-[#111111] flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="telefono" className="font-sans text-sm font-medium text-[#111111] flex items-center gap-2">
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Características del Inmueble</h2>
              <p className="font-sans text-sm text-[#6E6259] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#111111] flex items-center gap-2">
                ...
                >
                    ...
                    <Label
                      ...
                      className={`flex-1 cursor-pointer border rounded-2xl p-4 flex flex-col justify-between h-20 transition-all duration-300
                        ${watch("tipoOperacion") === "compra" 
                          ? "bg-white border-[#111111] shadow-elegant scale-[1.02]" 
                          : "bg-white/40 border-[#6E6259]/10 hover:bg-white/60"
                        }
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-[#111111]">Comprar</span>
                  ...
                  <div className="flex items-center space-x-2 flex-1">
                    ...
                    <Label
                      ...
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-[#111111]">Rentar</span>
              ...
              {/* Tipo de Propiedad */}
              <div className="space-y-2">
                <Label htmlFor="tipoPropiedad" className="font-sans text-sm font-medium text-[#111111]">
                  Tipo de Propiedad *
                </Label>
                <Select
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#6E6259] flex items-center gap-1.5">
                    <Bath className="w-3.5 h-3.5 text-[#111111]" />
                    Baños
                  </Label>
                  <Select
              ...
              <div className="space-y-2">
                <Label className="font-sans text-sm font-medium text-[#111111] flex items-center gap-2">
                  <Maximize className="w-4 h-4 text-[#111111]" />
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Ubicación y Estilo de Vida</h2>
              <p className="font-sans text-sm text-[#6E6259] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-full border border-[#6E6259]/20 bg-white/50 px-4 py-2 text-sm font-sans focus:bg-white/95 focus:border-[#111111]"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full bg-[#111111] hover:bg-[#9a5435]"
                  >
                    Agregar
                  </Button>
                </div>
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {estadosDeseados.map((estado: string) => (
                    <Badge key={estado} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-white border border-[#6E6259]/25 text-[#111111] flex items-center gap-1.5">
                      {estado}
                      <button
                        type="button"
              ...
              {/* Ciudades Deseadas */}
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#111111]">Ciudades o Municipios Específicos</Label>
                <div className="flex gap-2">
                  <Input
                    value={ciudadInput}
                    ...
                    className="rounded-full bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#111111]"
                  />
                  <Button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {ciudadesDeseadas.map((ciudad: string) => (
                    <Badge key={ciudad} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-white border border-[#6E6259]/25 text-[#111111] flex items-center gap-1.5">
                      {ciudad}
                      <button
                        type="button"
              ...
              {/* Zonas Específicas */}
              <div className="space-y-2">
                <Label htmlFor="zonasEspecificas" className="font-sans text-sm font-medium text-[#111111]">
              ...
              <div className="space-y-3 bg-[#FAF7F2]/60 border border-[#111111]/25 rounded-2xl p-5 md:p-6 shadow-card">
                <Label htmlFor="estiloVidaDescripcion" className="font-sans text-[#111111] font-medium text-base flex items-center gap-2">
                ...
                <Textarea
                  ...
                  className={`bg-white/70 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#111111] focus:ring-0 rounded-2xl ${
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Presupuesto y Financiamiento</h2>
              <p className="font-sans text-sm text-[#6E6259] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-[#FAF7F2]/60 border border-[#6E6259]/10 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <Label className="font-sans text-base font-semibold text-[#111111] flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`rounded-full pl-7 bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#111111] focus:ring-0 ${
                  ...
                  {METODOS_PAGO.map((metodo) => (
                    ...
                    >
                      <Checkbox
                        ...
                        className="mt-0.5 border-[#111111]/40 data-[state=checked]:bg-[#111111] data-[state=checked]:border-[#111111]"
                      />
                      <div className="flex-1">
                        <Label htmlFor={metodo.id} className="font-sans font-medium text-sm text-[#111111] cursor-pointer">
                          {metodo.label}
                        </Label>
              ...
              <div className="bg-white/40 border border-[#6E6259]/10 rounded-2xl p-5 shadow-card space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="tienePrecalificacion" className="font-sans font-medium text-[#111111]">
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Uso del Inmueble</h2>
              <p className="font-sans text-sm text-[#6E6259] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-[#111111]">¿Cuál será el uso de destino principal? *</Label>
                <RadioGroup
                        ...
                        <Label
                          ...
                          className={`flex-1 cursor-pointer border rounded-2xl p-4 flex gap-4 items-center transition-all duration-300 shadow-card
                            ${watch("usoDestino") === opc.id
                              ? "bg-white border-[#111111] scale-[1.01]"
                              : "bg-white/40 border-[#6E6259]/10 hover:bg-white/60"
                            }
                          `}
                        >
                          <div className="bg-[#FAF7F2] p-2.5 rounded-xl border border-[#6E6259]/10 text-[#111111]">
                            <Icon className="w-5 h-5" />
                          </div>
                          <div>
                            <span className="font-sans font-semibold text-sm text-[#111111]">{opc.label}</span>
              ...
              {/* Detalles del Uso */}
              <div className="space-y-2">
                <Label htmlFor="detallesUso" className="font-sans text-sm font-medium text-[#111111]">
                ...
                <Textarea
                  ...
                  className="bg-white/50 border-[#6E6259]/20 focus:bg-white/95 focus:border-[#111111] focus:ring-0 rounded-2xl"
                />
              </div>
            </div>
          </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl text-[#111111] font-medium">Expediente de Documentos</h2>
              <p className="font-sans text-sm text-[#6E6259] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              <div className="bg-[#FAF7F2]/60 border border-[#6E6259]/10 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <h3 className="font-sans text-base font-semibold text-[#111111] flex items-center gap-2">
                ...
                <div className="space-y-3">
                  {TIPOS_DOCUMENTOS.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="bg-white rounded-2xl p-4 border border-[#6E6259]/15 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-card hover:border-[#111111]/30 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          {uploadingDocs[doc.id] ? (
                            <Loader2 className="w-5 h-5 text-[#111111] animate-spin shrink-0" />
                          ) : isUploaded ? (
                          ...
                          <div>
                            <p className="font-sans font-medium text-sm text-[#111111]">
                              {doc.label}
                              {doc.requerido && <span className="text-red-500 ml-1">*</span>}
                            </p>
                            {uploadingDocs[doc.id] ? (
                              <span className="text-[10px] text-[#111111] font-sans font-medium animate-pulse">Subiendo a base de datos...</span>
                            ) : isUploaded ? (
                        ...
                        <div className="shrink-0 flex items-center gap-3">
                          <Button
                            ...
                            className={`rounded-full font-sans text-xs border-[#6E6259]/20 hover:bg-[#FAF7F2] hover:text-[#111111] ${
              ...
              {/* Nota de Alerta */}
              <div className="bg-[#FAF7F2] border border-[#111111]/20 rounded-2xl p-5 flex gap-3 shadow-card">
                <AlertCircle className="w-5 h-5 text-[#111111] shrink-0 mt-0.5" />
                <div className="text-xs text-[#6E6259] leading-relaxed">
                  <p className="font-sans font-semibold text-[#111111] mb-1">Políticas de Privacidad e Integridad:</p>
                  <p>
      ...
      <div className="flex justify-between items-center mt-8 gap-4 px-2">
        ...
        {currentStep < STEPS.length ? (
          <Button
            ...
            className="rounded-full px-8 bg-[#111111] hover:bg-[#9a5435] font-sans text-sm text-white shadow-md hover:scale-105 transition-all duration-300"
          >
            Siguiente
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="rounded-full px-8 bg-[#111111] hover:bg-[#9a5435] font-sans text-sm text-white shadow-md hover:scale-[1.03] transition-all duration-300"
          >
            {isSubmitting ? (
              <>
